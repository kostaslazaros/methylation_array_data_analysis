...
df <- read.csv(file="./diagenode_v2_results/normal_vs_indolent/data/normal_vs_indolent_bvals.csv", header=TRUE, row.names=1, stringsAsFactors=TRUE)
...
write.table(final_df, file="./diagenode_v2_results/normal_vs_indolent/data/normal_vs_indolent_heatmap_df.csv", sep=",", row.names=TRUE)
