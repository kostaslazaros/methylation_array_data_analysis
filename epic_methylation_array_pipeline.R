...
targets <- read.metharray.sheet("./step01_epic4dmp_indolent_vs_benign", pattern="SampleSheet.csv")
targets
...
# write.csv(bVals_df, file = "./step01_data_beta_vals.csv", row.names = TRUE)
